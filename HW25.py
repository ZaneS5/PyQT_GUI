# -*- coding: utf-8 -*-
"""
Created on Mon Apr  1 15:41:59 2019
...
app = QApplication(sys.argv)
ex = Example() 
quit # Using sys.exit(app.exec_()) causes system errors on my home machine  
# spyder also issues a worning about using this command 
